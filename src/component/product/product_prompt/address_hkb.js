...
var addressChoose = {
    ...
    run: function (details) {
        ...
        function xhr (xDetails,thisNum,returnNum,addressNum) {
            ...
            var bizContent = xDetails.bizContent || '2017071109001400000089_15575311169_oppGJ0zBVftagMTyIQqaFQ5y1sEM_101000000113330_00000045&parentId=';

            //接口地址 thisNum为id
            var addressUrl = thisUrl+'api/hkb/category/getJFCategories1?biz_content='+ bizContent + thisNum;
